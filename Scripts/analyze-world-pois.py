...
def build_allowed_names():
    poi_dirs = [
        "/mnt/c/Program Files (x86)/Steam/steamapps/common/7 Days To Die/Data/Prefabs/POIs",
        "/mnt/c/Users/zzton/AppData/Roaming/7DaysToDie/Mods/ZZTong-Prefabs/Prefabs/POIs",
        "/mnt/c/Users/zzton/AppData/Roaming/7DaysToDie/Mods/ZZTong-Prefabs/Prefabs/Traders",
        "/mnt/c/Users/zzton/AppData/Roaming/7DaysToDie/Mods/ZZTong-Prefabs/Prefabs/Underground",
    ]
    names = set()
    for d in poi_dirs:
        if os.path.isdir(d):
...
# Build the allowed names list dynamically from the POI prefab directories
